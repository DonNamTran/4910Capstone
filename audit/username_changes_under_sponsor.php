...
<?php
    ...
    $result = mysqli_query($connection, "SELECT * FROM audit_log_username_changes_view_drivers_under_sponsor WHERE driver_associated_sponsor = '$sponsor_name' ORDER BY audit_log_username_changes_date DESC");
?>

<div class="div_before_table">
<table>
    <tr>
        <th class="sticky">Old Username</th>
        <th class="sticky">New Username</th>
    ...
    <tr>
        <!-- FETCHING DATA FROM EACH
            ROW OF EVERY COLUMN -->
        <td><?php echo $rows['audit_log_username_changes_old_username'];?></td>
        <td><?php echo $rows['audit_log_username_changes_new_username'];?></td>
        <td><?php echo $rows['audit_log_username_changes_date'];?></td>
    </tr>
    <?php
        }
    ?>
