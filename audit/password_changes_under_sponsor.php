...
<?php
    ...
    $result2 = mysqli_query($connection, "SELECT * FROM audit_log_password_view_drivers_under_sponsor WHERE organization_username = '$sponsor_name' ORDER BY audit_log_password_date DESC");
?>
