...
<?php
    ...
    if($driver_username === "All Drivers") {
        ...
        if($al_type === "Point Changes") {
            $points_query = mysqli_query($connection, "SELECT * FROM point_history JOIN drivers ON point_history.point_history_driver_id=drivers.driver_id  JOIN driver_sponsor_assoc ON driver_sponsor_assoc.driver_id = drivers.driver_id JOIN organizations ON driver_sponsor_assoc.assoc_sponsor_id=organizations.organization_id WHERE point_history_date BETWEEN '$start_range' AND '$end_range_format' AND organization_username='$org_name'");  
        ...
        if($al_type === "Point Changes") {
            $points_query = mysqli_query($connection, "SELECT * FROM point_history JOIN drivers ON point_history.point_history_driver_id=drivers.driver_id  JOIN driver_sponsor_assoc ON driver_sponsor_assoc.driver_id = drivers.driver_id JOIN organizations ON driver_sponsor_assoc.assoc_sponsor_id=organizations.organization_id WHERE point_history_date BETWEEN '$start_range' AND '$end_range_format' AND organization_username='$org_name' AND driver_username='$driver_username';");    
