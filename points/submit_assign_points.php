...
if(!($driver_id_query2->fetch_row())){
    ...
    var_dump("after sql audit prepare");
    $stmt_audit->bind_param("sssi", $username, $regDate, $reason, "+ ". $rows['driving_behavior_point_val']);
    var_dump("after sql audit bind param");
