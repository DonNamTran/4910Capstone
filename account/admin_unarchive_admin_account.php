...
<?php
    ...
    $result = mysqli_query($connection, "SELECT * FROM administrators WHERE administrator_archived=1;");
?>
...
<!-- Get User Input -->
<form action="submit_admin_unarchive_admin_account.php" method="POST">
  <label for="admin_id">Admin ID:</label><br>
  <input type="text" id="admin_id" name="admin_id" placeholder="Enter in the associated ID number of the admin whose account you'd like to unarchive." required><br>
