...
<?php
    ...
    $result2 = mysqli_query($connection, "SELECT * FROM sponsors WHERE sponsor_associated_sponsor = '$sponsor_name' and sponsor_archived=0");
?>
...
<table>
    <tr>
        ...
        <th class="sticky">Archive Sponsor</th>
    </tr>
    ...
    <tr>
        ...
        <td>
            <form action="http://team05sif.cpsc4911.com/S24-Team05/account/submit_sponsor_archive_sponsor_account.php" method="post">
