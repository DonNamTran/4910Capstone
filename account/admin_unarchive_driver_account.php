...
<?php
    ...
    $result = mysqli_query($connection, "SELECT * FROM drivers WHERE driver_archived=1;");
?>
...
<table>
    ...
    <tr>
        ...
        <td>
            <form action="http://team05sif.cpsc4911.com/S24-Team05/account/submit_admin_unarchive_driver_account.php" method="post">
